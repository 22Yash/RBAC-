...
const UserTable = ({ users, onEdit, onDelete }) => (
  <div className="w-[420px] xl:w-full p-6 rounded-lg bg-[#263180]">
    <h2 className="text-white font-bold text-lg mb-4">Authors Table</h2>
    <table
...
>
  <thead>
    <tr className="text-gray-400 text-sm border-b border-gray-700 h-[70px]">
      <th className="py-2 px-4 text-center w-1/4">Name</th> 
      <th className="py-2 px-7  text-center w-1/4 ">Role</th> 
  ...
  <tbody>
    {users.map((user) => (
      ...
      >
        <td className="xl:py-4 py-9 px-4 text-white font-medium flex items-center text-center space-x-3 w-2/4">
        ...
        <td className={`py-4 px-4 font-semibold w-1/4 ${user.active ? "text-green-500" : "text-red-500"}`}>
